...
<div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
  ...
  <div class="mx-auto max-w-2xl text-center">
    ...
    <p class="mt-2 text-lg leading-8 text-gray-600">Books are expensive! By sharing your paper books with friends and
      family using BookStore you save money, save trees and read more books.</p>
  </div>
  <form action="#" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
    ...
    <div class="mt-10">
      <button type="submit"
        class="block w-full rounded-md bg-indigo-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Share
        Book</button>
    </div>
  </form>
</div>
