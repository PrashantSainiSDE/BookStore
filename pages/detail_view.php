...
if($result->num_rows != 1):
  ...
  <div class="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 py-24 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
    <div>
      ...
      <p class="mt-4 text-gray-500"> We're sorry, but we couldn't find the book you're looking for. It may have been removed, or perhaps it never existed. Please check the book ID or try searching for another title. If you believe this is an error, feel free to contact our support team for further assistance.
      </p>
    </div>
  </div>
</div>
...
<div class="bg-white">
  <div class="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 py-24 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
    <div>
      <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl"><?php echo htmlspecialchars(ucfirst($book['title']))?></h2>
